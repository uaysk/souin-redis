...
This is a distributed HTTP cache module for Dotweb based on [Souin](https://github.com/uaysk/souin-redis) cache.  
...
See the [Souin](https://github.com/uaysk/souin-redis) configuration for the full configuration, and its associated [development dotweb middleware](https://github.com/uaysk/souin-redis/blob/master/plugins/dotweb)  
